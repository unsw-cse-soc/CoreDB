 ...
 * @author vmc
 */
public class EntityCoreTableClass extends EntityClass implements ClassToTables {
     ...
     */
	public EntityCoreTableClass(String name, AttributeClass[] attributeClassList, IndexClass[] indexClassList) {
